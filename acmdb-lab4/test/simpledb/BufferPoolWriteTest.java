...
public class BufferPoolWriteTest extends TestUtil.CreateHeapFile {
    ...
    class HeapFileDuplicates extends HeapFile {
    	...
    	public HeapFileDuplicates(File f, TupleDesc td, int duplicates) {
    		...
    		System.out.printf("should be 0, real be: %d\n",(super.numPages()));
    	}
    	...
    	public ArrayList<Page> insertTuple(TransactionId tid, Tuple t)
    		...
    		for(int i = 0; i < duplicates; i++) {
                ...
                bw.write(emptyData);
                bw.close();
                System.out.printf("should be %d, real be: %d\n",i,super.numPages()-1);
    			HeapPage p = new HeapPage(new HeapPageId(super.getId(), super.numPages() - 1), 
    					HeapPage.createEmptyPageData());
    	        p.insertTuple(t);
    			dirtypages.add(p);
    		}
    		System.out.printf("should be unknows, real be: %d\n",(super.numPages()));
    		return dirtypages;
    	}
    }
    ...
    @Test public void handleManyDirtyPages() throws Exception {
    	...
    	it.open();
    	System.out.printf("it.open should be 10, real be: %d\n",hfd.numPages());
    	int count = 0;
    	while(it.hasNext()) {
    		it.next();
    		count++;
    	}
    	System.out.printf("should be 10, real be: %d\n",(count));
